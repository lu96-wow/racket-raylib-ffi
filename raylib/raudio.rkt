...
;; Wave: unsigned int frameCount; unsigned int sampleRate; unsigned int sampleSize; unsigned int channels; void *data
(define _wave-bytes
  (_list-struct _uint _uint _uint _uint _pointer))
...
(define init-audio-device
  (get-ffi-obj "InitAudioDevice" lib (_fun -> _void)))
(define close-audio-device
  (get-ffi-obj "CloseAudioDevice" lib (_fun -> _void)))
(define is-audio-device-ready?
  (get-ffi-obj "IsAudioDeviceReady" lib (_fun -> _stdbool)))
(define set-master-volume
  (get-ffi-obj "SetMasterVolume" lib (_fun _float -> _void)))
(define get-master-volume
  (get-ffi-obj "GetMasterVolume" lib (_fun -> _float)))
...
(define load-wave-from-memory
  (let ([f (get-ffi-obj "LoadWaveFromMemory" lib (_fun _string _pointer _int -> (w : _wave-bytes)))])
...
(define load-sound-from-wave
  (let ([f (get-ffi-obj "LoadSoundFromWave" lib (_fun (w : _wave-bytes) -> (s : _sound-bytes)))])
    (lambda (wave) (f wave))))

(define load-sound-alias
  (let ([f (get-ffi-obj "LoadSoundAlias" lib (_fun (s : _sound-bytes) -> (a : _sound-bytes)))])
...
(define update-sound
  (get-ffi-obj "UpdateSound" lib (_fun _pointer _pointer _int -> _void)))

(define unload-wave
  (get-ffi-obj "UnloadWave" lib (_fun (w : _wave-bytes) -> _void)))

(define unload-sound
  (get-ffi-obj "UnloadSound" lib (_fun (s : _sound-bytes) -> _void)))

(define unload-sound-alias
  (get-ffi-obj "UnloadSoundAlias" lib (_fun (s : _sound-bytes) -> _void)))
...
(define export-wave-as-code
  (let ([f (get-ffi-obj "ExportWaveAsCode" lib (_fun (w : _wave-bytes) _string -> _stdbool))])
    (lambda (wave file-name) (f wave file-name))))
...
(define play-sound
  (get-ffi-obj "PlaySound" lib (_fun (s : _sound-bytes) -> _void)))
(define stop-sound
  (get-ffi-obj "StopSound" lib (_fun (s : _sound-bytes) -> _void)))
(define pause-sound
  (get-ffi-obj "PauseSound" lib (_fun (s : _sound-bytes) -> _void)))
(define resume-sound
  (get-ffi-obj "ResumeSound" lib (_fun (s : _sound-bytes) -> _void)))
(define is-sound-playing?
  (let ([f (get-ffi-obj "IsSoundPlaying" lib (_fun (s : _sound-bytes) -> _stdbool))])
    (lambda (sound) (f sound))))
(define set-sound-volume
  (get-ffi-obj "SetSoundVolume" lib (_fun (s : _sound-bytes) _float -> _void)))
(define set-sound-pitch
  (get-ffi-obj "SetSoundPitch" lib (_fun (s : _sound-bytes) _float -> _void)))
(define set-sound-pan
  (get-ffi-obj "SetSoundPan" lib (_fun (s : _sound-bytes) _float -> _void)))

(define wave-copy
  (let ([f (get-ffi-obj "WaveCopy" lib (_fun (w : _wave-bytes) -> (out : _wave-bytes)))])
    (lambda (wave) (f wave))))
(define wave-crop
  (get-ffi-obj "WaveCrop" lib (_fun _pointer _int _int -> _void)))
(define wave-format
  (get-ffi-obj "WaveFormat" lib (_fun _pointer _int _int _int -> _void)))
(define load-wave-samples
  (get-ffi-obj "LoadWaveSamples" lib (_fun (w : _wave-bytes) -> _pointer)))
(define unload-wave-samples
  (get-ffi-obj "UnloadWaveSamples" lib (_fun _pointer -> _void)))
...
(define load-audio-stream
  (get-ffi-obj "LoadAudioStream" lib (_fun _uint _uint _uint -> (s : _audio-stream-bytes))))

(define is-audio-stream-valid
  (get-ffi-obj "IsAudioStreamValid" lib (_fun (s : _audio-stream-bytes) -> _stdbool)))

(define unload-audio-stream
  (get-ffi-obj "UnloadAudioStream" lib (_fun (s : _audio-stream-bytes) -> _void)))

(define update-audio-stream
  (get-ffi-obj "UpdateAudioStream" lib (_fun (s : _audio-stream-bytes) _pointer _int -> _void)))

(define is-audio-stream-processed?
  (get-ffi-obj "IsAudioStreamProcessed" lib (_fun (s : _audio-stream-bytes) -> _stdbool)))
...
(define is-audio-stream-playing?
  (get-ffi-obj "IsAudioStreamPlaying" lib (_fun (s : _audio-stream-bytes) -> _stdbool)))

(define stop-audio-stream
  (get-ffi-obj "StopAudioStream" lib (_fun (s : _audio-stream-bytes) -> _void)))

(define set-audio-stream-volume
  (get-ffi-obj "SetAudioStreamVolume" lib (_fun (s : _audio-stream-bytes) _float -> _void)))

(define set-audio-stream-pitch
  (get-ffi-obj "SetAudioStreamPitch" lib (_fun (s : _audio-stream-bytes) _float -> _void)))

(define set-audio-stream-pan
  (get-ffi-obj "SetAudioStreamPan" lib (_fun (s : _audio-stream-bytes) _float -> _void)))
...
(provide
 ...
 load-wave load-wave-from-memory is-wave-valid
 load-sound load-sound-from-wave load-sound-alias is-sound-valid
 update-sound unload-wave unload-sound unload-sound-alias
