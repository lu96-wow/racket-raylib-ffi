...
;; types/wave.rkt — Wave (20 bytes)

(require ffi/unsafe)

(define-cstruct _Wave
  ([frameCount _uint] [sampleRate _uint] [sampleSize _uint]
   [channels _uint] [data _pointer]))
...
(provide _Wave _wave-bytes
         wave-frame-count wave-sample-rate wave-sample-size
         wave-channels wave-data)
