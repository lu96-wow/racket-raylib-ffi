...
(define-cstruct _RenderTexture
  ([id _uint] [tex-id _uint] [tex-width _int] [tex-height _int] [tex-mipmaps _int] [tex-format _int]
...
(define (render-texture id tex-id tex-w tex-h tex-m tex-f dep-id dep-w dep-h dep-m dep-f)
  (let ([rt (malloc _RenderTexture 'atomic)])
    (ptr-set! rt _uint 0 id) (ptr-set! rt _uint 1 tex-id) (ptr-set! rt _int 2 tex-w)
    (ptr-set! rt _int 3 tex-h) (ptr-set! rt _int 4 tex-m) (ptr-set! rt _int 5 tex-f)
    (ptr-set! rt _uint 6 dep-id) (ptr-set! rt _int 7 dep-w) (ptr-set! rt _int 8 dep-h)
    (ptr-set! rt _int 9 dep-m) (ptr-set! rt _int 10 dep-f) rt))
...
(provide _RenderTexture _render-texture-bytes render-texture
         render-texture-id render-texture-tex-id render-texture-tex-width render-texture-tex-height
