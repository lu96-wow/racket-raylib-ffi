...
(define _rectangle-bytes (_list-struct _float _float _float _float))

(define (rectangle->bytes r)
  (list (ptr-ref r _float 0) (ptr-ref r _float 1)
        (ptr-ref r _float 2) (ptr-ref r _float 3)))

(define (bytes->rectangle lst)
  (let ([r (malloc _Rectangle 'atomic)])
