...
;; core/rlgl.rkt — rlgl 底层 OpenGL 抽象函数绑定
;;
;; 只包含 FFI 函数绑定。常量在 raylib-var/ 中。
...
(def-ffi rl-update-texture "rlUpdateTexture"
         (_fun _uint _int _int _int _int _int _pointer -> _void))
...
(def-ffi rl-frustum     "rlFrustum"     (_fun _double _double _double
                                             _double _double _double -> _void))
(def-ffi rl-ortho       "rlOrtho"       (_fun _double _double _double
                                             _double _double _double -> _void))
...
(def-ffi rl-set-blend-factors-separate "rlSetBlendFactorsSeparate"
         (_fun _int _int _int _int _int _int -> _void))
...
(def-ffi rl-clear-color       "rlClearColor"
         (_fun _ubyte _ubyte _ubyte _ubyte -> _void))
...
(def-ffi rl-load-vertex-buffer    "rlLoadVertexBuffer"
         (_fun _pointer _int _stdbool -> _uint))
(def-ffi rl-update-vertex-buffer  "rlUpdateVertexBuffer"
         (_fun _uint _pointer _int _int -> _void))
(def-ffi rl-unload-vertex-buffer  "rlUnloadVertexBuffer"  (_fun _uint -> _void))
(def-ffi rl-set-vertex-attribute  "rlSetVertexAttribute"
         (_fun _uint _int _int _stdbool _int _int -> _void))
(def-ffi rl-draw-vertex-array     "rlDrawVertexArray"     (_fun _int _int -> _void))
(def-ffi rl-draw-vertex-array-elements "rlDrawVertexArrayElements"
         (_fun _int _int _pointer -> _void))
(def-ffi rl-draw-vertex-array-instanced "rlDrawVertexArrayInstanced"
...
(def-ffi rl-load-shader-program   "rlLoadShaderProgram"
         (_fun _string _string -> _uint))
...
(def-ffi rl-framebuffer-attach    "rlFramebufferAttach"
         (_fun _uint _uint _int _int _int -> _void))
...
(def-ffi rl-load-texture-depth     "rlLoadTextureDepth"
         (_fun _int _int _stdbool -> _uint))
(def-ffi rl-load-texture-cubemap   "rlLoadTextureCubemap"
         (_fun _pointer _int _int _int -> _uint))
...
(provide
 ...
 RL-ONE-MINUS-SRC-ALPHA RL-DST-COLOR RL-ONE-MINUS-DST-COLOR
 RL-MIN RL-MAX
 ...
 rl-load-framebuffer rl-framebuffer-attach rl-framebuffer-complete
