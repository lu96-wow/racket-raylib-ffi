...
(define SHADER-LOC-MATRIX-MVP 0)
(define SHADER-LOC-MATRIX-VIEW 1)
(define SHADER-LOC-MATRIX-PROJECTION 2)
(define SHADER-LOC-MATRIX-MODEL 3)
(define SHADER-LOC-MATRIX-NORMAL 4)

;; Shader location: texture maps
(define SHADER-LOC-MAP-ALBEDO       0)
(define SHADER-LOC-MAP-METALNESS    1)
(define SHADER-LOC-MAP-NORMAL       2)
(define SHADER-LOC-MAP-ROUGHNESS    3)
(define SHADER-LOC-MAP-OCCLUSION    4)
(define SHADER-LOC-MAP-EMISSION     5)
(define SHADER-LOC-MAP-HEIGHT       6)
(define SHADER-LOC-MAP-CUBEMAP      7)
(define SHADER-LOC-MAP-IRRADIANCE   8)
(define SHADER-LOC-MAP-PREFILTER    9)
(define SHADER-LOC-MAP-BRDF        10)
